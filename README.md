...
### Overview
The project covers:
- Fetching vacancy data using `curl`
- Parsing JSON with `jq`
- Converting JSON to CSV
- Sorting structured data
- Cleaning position titles (Junior/Middle/Senior extraction)
...
- Dictionary lookups (by key and value)
...
### Overview
The project progressively builds an analytical tool for coin toss data using:
- Classes and methods
